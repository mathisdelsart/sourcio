...
_SYSTEM = (
    ...
    "- Build exactly {n} distinct question(s) ONLY on a concept, method or formula"
    " the numbered sources actually STATE. You are the judge of coverage, and the"
    " bar is the SPECIFIC notion asked for, not the broad topic.\n"
    "- If the sources do not contain that exact concept, method or formula — even"
    " when they share notation, mention a related idea, or are about the same broad"
    f" subject — reply with exactly this sentence and nothing else: {REFUSAL}\n"
    ...
    " gap in the sources; keep the course's notation.\n"
