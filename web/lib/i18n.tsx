...
const en = {
  ...
  "doc.upload.openaiKey": "OpenAI API key — for importing scanned PDFs",
  "doc.upload.openaiKeyHint":
    "Optional. Only used to read scanned or image-based PDFs, sent only when you upload, and stored in your browser (never on our server). Text PDFs and .md/.txt files import for free without a key.",
...
const fr: Record<TranslationKey, string> = {
  ...
  "doc.upload.openaiKey": "Clé API OpenAI — pour importer des PDF scannés",
  "doc.upload.openaiKeyHint":
    "Optionnel. Utilisée uniquement pour lire des PDF scannés ou basés sur des images, envoyée seulement lors de l’import, et conservée dans votre navigateur (jamais sur notre serveur). Les PDF texte et les fichiers .md/.txt s’importent gratuitement, sans clé.",
...
const nl: Record<TranslationKey, string> = {
  ...
  "doc.upload.openaiKey": "OpenAI API-sleutel — voor het importeren van gescande PDF’s",
  "doc.upload.openaiKeyHint":
    "Optioneel. Wordt alleen gebruikt om gescande of op afbeeldingen gebaseerde PDF’s te lezen, alleen verzonden bij het uploaden en opgeslagen in uw browser (nooit op onze server). Tekst-PDF’s en .md/.txt-bestanden worden gratis geïmporteerd, zonder sleutel.",
